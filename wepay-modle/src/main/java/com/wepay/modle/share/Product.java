...
public class Product implements Serializable {
	...
	private String productId;//订单商品ID
	private String subject;//订单名称 
	private String body;//商品描述
	private String totalFee;//订单总金额(单位是分)
	private String outTradeNo;//订单号(唯一)
	private String spbillCreateIp;//发起人IP地址
	private String attach;//附件数据主要用于商户携带订单的自定义数据
	private Short payType;//用户支付类型(1:支付宝 2:微信 3:银联)
	private Short payWay;//用户支付方式 (1：PC,平板 2：手机)
